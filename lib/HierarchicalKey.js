...
var HierarchicalKey = function(bytes) {
  if (typeof bytes == 'undefined' || bytes == 'mainnet' || bytes == 'aeqdlivenet') {
    bytes = 'aeqdlivenet';
    this.version = networks['aeqdlivenet'].hkeyPrivateVersion;
  } else if (bytes == 'aeqdtestnet') {
    this.version = networks['aeqdtestnet'].hkeyPrivateVersion;
  }
  if (bytes == 'aeqdlivenet' || bytes == 'aeqdtestnet') {
    this.depth = 0x00;
...
HierarchicalKey.prototype.initFromBytes = function(bytes) {
  ...
  var isPublic =
    (this.version == networks['aeqdlivenet'].hkeyPublicVersion ||
      this.version == networks['aeqdtestnet'].hkeyPublicVersion);
...
HierarchicalKey.prototype.buildExtendedPublicKey = function() {
  ...
  var v = null;
  switch (this.version) {
    case networks['aeqdlivenet'].hkeyPublicVersion:
    case networks['aeqdlivenet'].hkeyPrivateVersion:
      v = networks['aeqdlivenet'].hkeyPublicVersion;
      break;
    case networks['aeqdtestnet'].hkeyPublicVersion:
    case networks['aeqdtestnet'].hkeyPrivateVersion:
      v = networks['aeqdtestnet'].hkeyPublicVersion;
      break;
    default:
