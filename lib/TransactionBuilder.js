...
TransactionBuilder.infoForP2sh = function(opts, networkName) {
  ...
  var version = networkName === 'aeqdtestnet' ?
    networks.aeqdtestnet.P2SHVersion : networks.aeqdlivenet.P2SHVersion;
...
TransactionBuilder.prototype._multiFindKey = function(walletKeyMap, pubKeyHash) {
  var wk;
  [networks.aeqdlivenet, networks.aeqdtestnet].forEach(function(n) {
